...
DEFAULT_ACCOUNT_USERNAME = os.environ.get("DEFAULT_ACCOUNT_USERNAME", "demo")
DEFAULT_ACCOUNT_PASSWORD = os.environ.get("DEFAULT_ACCOUNT_PASSWORD", "demo1234")
...
# Allow either local hostname while developing the frontend.
