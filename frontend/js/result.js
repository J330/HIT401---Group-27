...
if (!raw) {
  ...
  container.innerHTML = `
    ...
    ${result.id === null ? '<p>This scan was not saved. <a href="account.html">Log in</a> before your next scan to add it to your dashboard.</p>' : '<p>This scan was saved to your dashboard.</p>'}
  `;
}
